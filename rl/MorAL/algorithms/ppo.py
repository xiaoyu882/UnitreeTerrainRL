...
from rl.MorAL.modules import ActorCritic
from rl.MorAL.storage import RolloutStorage

from rl.MorAL.modules.actor_critic import DmEncoder
...
class PPO:
    ...
    def update(self):
        ...
        for obs_batch, critic_obs_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, \
            ...
            morph_mass_loss = F.mse_loss(pre_morph[:, 0:4], real_morph[:, 0:4].detach())

            morph_size_loss = F.mse_loss(pre_morph[:, 4:], real_morph[:, 4:].detach())

            loss_encoder = vel_loss + morph_size_loss + morph_mass_loss
            ...
            mean_morph_size_loss += morph_size_loss.item()
        ...
        return mean_value_loss, mean_surrogate_loss, mean_vel_loss, mean_morph_loss, mean_morph_size_loss
