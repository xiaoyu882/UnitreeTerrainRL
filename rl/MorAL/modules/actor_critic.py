...
class ActorCritic(nn.Module):
    ...
    def _actor_critic(self, obs_dict):
        ...
        obs_kp_kd = obs_dict['privileged_info'][:, 209:223]
        obs_friction = obs_dict['privileged_info'][:, 223:224]
        ...
        actor_obs = torch.cat([pre_obs_vel, obs, pre_obs_morph], dim=-1)  ## 45 + 3
        critic_obs = torch.cat([obs_vel, obs, obs_morph, obs_hight, obs_push, obs_friction, obs_kp_kd],
                               dim=-1)  ## 45+3+187 = 235
